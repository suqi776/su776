...
<template>
  <svg class="animated-signature" viewBox="0 0 136.1 78.401" xmlns="http://www.w3.org/2000/svg" style="overflow: visible;">
    <g id="svgGroup" stroke-linecap="round" fill-rule="evenodd" font-size="9pt" :stroke="logoColor" :stroke-width="strokeWidth" fill="#000">
